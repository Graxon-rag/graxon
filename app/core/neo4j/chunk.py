from ..schemas.chunk_schema import Chunk, N4jChunkEdge, ChunkVecSimilarity, ChunkPrevNext, VectorSimilarity, ChunkPrevNextSchema
        ...
        try:
            ...
            return [
                ChunkPrevNextSchema(
                    ...
                    weight=1.0,  # Because this is the main chunk so weight is always 1
