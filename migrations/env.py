...
GRAXON_OWNED_TABLES = [PGTables.ORGANIZATION_TABLE, PGTables.PROJECT_TABLE, PGTables.RERANKER_MODEL_TABLE, PGTables.SPARSE_TEXT_MODEL_TABLE, PGTables.MODEL_CREDENTIAL_TABLE, PGTables.LLM_MODEL_TABLE, PGTables.EMBEDDING_MODEL_TABLE, PGTables.DOCUMENT_TABLE]
